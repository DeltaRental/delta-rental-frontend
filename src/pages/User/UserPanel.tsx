...
function UserPanel({}: Props) {
  ...
  return (
    <div className="container mx-auto mt-5">
      <div className="md:grid md:grid-cols-12 min-h-screen text-black bg-delta-green-800  rounded-lg">
        <ul className="col-span-2  space-y-4 text-base font-medium md:me-4 mb-4 md:mb-0 mt-7 ms-2">
          <li>
            <Link
              to={"/profile"}
